vflayout2ghr <- function( vf, pwidth = 8.27, pheight = 11.69, margin = 0.25,
                      filename = NULL ) {
...
# total-deviation plot
  ...
  vfplot2( vf, plotType = "td", txtfont = ffamilyvf, pointsize = pointsize,
...
# sensitivity plot
  ...
  vfplot2( vf, plotType = "vf", txtfont = ffamilyvf, pointsize = pointsize,
          xminmax = xminmax, yminmax = yminmax,
          outerSymbol = outerSymbol, innerSymbol = innerSymbol,
          outerInch = outerInch, innerInch = innerInch,
          lengthLines = lengthLines, thicknessLines = thicknessLines )
# pattern-deviation plot
  ...
  vfplot2( vf, plotType = "pdghr", txtfont = ffamilyvf, pointsize = pointsize,
          xminmax = xminmax, yminmax = yminmax,
          outerSymbol = outerSymbol, innerSymbol = innerSymbol,
          outerInch = outerInch, innerInch = innerInch,
          lengthLines = lengthLines, thicknessLines = thicknessLines )
...
# color-code map
  ...
  colormapgraph2( ncol = 6, txtfont = ffamilyvf, pointsize = pointsize, outerSymbol = outerSymbol, innerSymbol = innerSymbol,
                 outerInch = outerInch, innerInch = innerInch )
  par( opar )
